...
export const UploaderEditIcon = ({ onClick }: { onClick: () => void }) => (
  <div
    className={uploaderStyles.editIcon}
    onClick={onClick}
...
export const UploaderSaveIcon = ({ onClick }: { onClick: () => void }) => (
  <div
    className={uploaderStyles.saveIcon}
    onClick={onClick}
    title="Save changes"
  >
    <svg
...
export const UploaderCancelIcon = ({ onClick }: { onClick: () => void }) => (
  <div
    className={uploaderStyles.cancelIcon}
    onClick={onClick}
